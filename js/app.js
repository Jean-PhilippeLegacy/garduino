...
(function(){
    ...
    function scrollFunction(){
        var rootDifference = rootsImg.getBoundingClientRect().top - window.innerHeight + 50;
        var crl1Difference = crl1.getBoundingClientRect().top - window.innerHeight + 50;
        var crl2Difference = crl2.getBoundingClientRect().top - window.innerHeight + 50;
        var crl3Difference = crl3.getBoundingClientRect().top - window.innerHeight + 50;
